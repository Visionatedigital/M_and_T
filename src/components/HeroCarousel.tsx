...
const slides = [
  {
    ...
    description: "Loan Amount UGX 1,000,000 - 50,000,000",
    term: "Term 1 - 6 Months | Collateral Required",
    image: personalImg,
    link: "/products?section=personal",
  },
  {
    id: 2,
    title: "Civil Servants Loans",
    description: "From UGX 1,000,000 - 50,000,000",
    term: "Term 1 - 6 Months | Collateral Required",
    image: civilServantImg,
    link: "/products?section=civil",
  },
  {
    id: 3,
    title: "Logbook Finance Loans",
    description: "From UGX 1,000,000 - 50,000,000",
    term: "Term 1 - 6 Months | Logbook Backed",
    image: logbookImg,
    link: "/products?section=logbook",
  },
  {
    id: 4,
          ...
          <div className="relative container mx-auto px-4 h-full flex items-center">
            <div className="max-w-2xl animate-fade-in">
              <div className="bg-brand-blue/90 backdrop-blur-sm p-8 md:p-12 rounded-lg shadow-2xl">
                ...
                <p className="text-lg md:text-xl text-white/95 mb-2">{slide.description}</p>
                <p className="text-base md:text-lg text-white/90 mb-6">{slide.term}</p>
                <Link to={slide.link}>
                  <Button
                    variant="secondary"
                    size="lg"
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`h-2 rounded-full transition-all ${
              index === currentSlide ? "w-8 bg-brand-red" : "w-2 bg-white/50 hover:bg-white/70"
            }`}
